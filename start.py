...
class Lavalink:
    def __init__(self):
        ...
        self.replace_password_command = 'sed -i "s|lilrei2021app|$PASSWORD|" application.yml'
        self.replace_password_command_no_password = 'sed -i "s|lilrei2021app|youshallnotpass|" application.yml'
